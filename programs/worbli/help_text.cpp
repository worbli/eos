...
You can check the contract's abi by using 'worbli get code' command.)=====";
...
If you are currently using 'worbli push action' command, try to add the relevant authority using -p option.)=====";
